...
{
    public partial class MA_C27_SearchPatients : Form
    {
        public MA_C27_SearchPatients()
        {
            InitializeComponent();
        }
        ...
        private void btnTestClient_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("Results_a:"+results_a);
                ...
                MessageBox.Show("Results_b:" + results_b);
                ...
                MessageBox.Show("Results_c:" + results_c);
