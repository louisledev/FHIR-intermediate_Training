...
{
    public partial class EX_C12_PopulatePatient : Form
    {
        public EX_C12_PopulatePatient()
        {
            InitializeComponent();
        }
        ...
        private void btnTestClient_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            //Identifiers
            p.Identifier.Add
                (new Identifier() { System = "http://citizens-id.gov/citizens", Value = "69999999-I"
                ,Use=Identifier.IdentifierUse.Official});
            p.Identifier.Add
                (new Identifier() { System = "http://hospital.gov/patients", Value = "9999999" });
            //Attachments
            byte[] imageBytes;
            ...
            try
            {
                ...
                MessageBox.Show("Patient:" + PatientCreated.Id + " " + "Observation:" + ObservationCreated.Id);
            }
            catch (FhirOperationException Exc)
            {
                MessageBox.Show(Exc.Outcome.ToString());
        ...
        private void EX_C12_PopulatePatient_Load(object sender, EventArgs e)
        {
