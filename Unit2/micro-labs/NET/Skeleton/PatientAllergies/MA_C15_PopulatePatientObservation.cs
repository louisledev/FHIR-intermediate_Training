...
{
    public partial class MA_C15_PopulatePatientObservation : Form
    {
        public MA_C15_PopulatePatientObservation()
        {
            InitializeComponent();
        }
...
Observation: Lab –Serum Creatinine Value: 65 umol/L, March 3, 2020 07:00:00 EST / LOINC Code: 14682-9 (http://loinc.org)
            ...
            p.Identifier.Add
                (new Identifier() { System = "http://nygc.com/patients", Value = "1234567" });
            //Attachments
            byte[] imageBytes;
