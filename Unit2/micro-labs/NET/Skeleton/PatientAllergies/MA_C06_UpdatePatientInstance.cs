...
{
    public partial class MA_C06_UpdatePatientInstance : Form
    {
        public MA_C06_UpdatePatientInstance()
        {
            InitializeComponent();
        }
        ...
        private void btnTestClient_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show(UpdatedPatient.VersionId);
        ...
        private void MA_C06_UpdatePatientInstance_Load(object sender, EventArgs e)
        {
